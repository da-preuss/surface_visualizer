...
class VAO:
	...
	def attach_vertex_buffer(self, attrib_location, vertex_data, size_element, usage = gl.GL_STATIC_DRAW):
		self.bind()
		...
		gl.glBufferData(gl.GL_ARRAY_BUFFER, len(vertex_data) * ctypes.sizeof(ctypes.c_float), vertex_data.tobytes(), usage)
